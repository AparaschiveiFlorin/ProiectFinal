...
class TestPretdescrescator():
  ...
  def test_pretdescrescator(self):
    # Test name: pretdescrescator
    ...
    # 11 | click | linkText=Price, low to high | 
    ...
    # 24 | type | id=field-postcode | 50017
    self.driver.find_element(By.ID, "field-postcode").send_keys("50017")
    ...
    # 28 | click | id=conditions-to-approve | 
    self.driver.find_element(By.ID, "conditions-to-approve").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".select-title").click()
    # 34 | click | linkText=Price, low to high | 
    self.driver.find_element(By.LINK_TEXT, "Price, low to high").click()
