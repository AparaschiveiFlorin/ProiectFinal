...
class TestProdusvechiverificat():
  ...
  def test_produsvechiverificat(self):
    # Test name: produsvechiverificat
    ...
    # 10 | click | linkText=All new products | 
    ...
    # 12 | click | linkText=Date added, oldest to newest | 
    ...
    # 14 | click | css=.btn-primary > .material-icons | 
    ...
    # 31 | click | css=.logo | 
    self.driver.find_element(By.CSS_SELECTOR, ".logo").click()
    # 32 | click | linkText=All new products | 
    self.driver.find_element(By.LINK_TEXT, "All new products").click()
    # 33 | click | css=.select-title | 
    self.driver.find_element(By.CSS_SELECTOR, ".select-title").click()
    # 34 | click | linkText=Date added, oldest to newest | 
    self.driver.find_element(By.LINK_TEXT, "Date added, oldest to newest").click()
