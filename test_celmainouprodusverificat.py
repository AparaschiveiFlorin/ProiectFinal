...
class TestCelmainouprodusverificat():
  ...
  def test_celmainouprodusverificat(self):
    # Test name: celmainouprodusverificat
    ...
    # 32 | click | css=.logo | 
    self.driver.find_element(By.CSS_SELECTOR, ".logo").click()
    # 33 | click | linkText=All new products | 
    self.driver.find_element(By.LINK_TEXT, "All new products").click()
    # 34 | click | css=.select-title | 
    self.driver.find_element(By.CSS_SELECTOR, ".select-title").click()
    # 35 | click | linkText=Date added, newest to oldest | 
    self.driver.find_element(By.LINK_TEXT, "Date added, newest to oldest").click()
    # 36 | click | css=.js-product:nth-child(1) img | 
    self.driver.find_element(By.CSS_SELECTOR, ".js-product:nth-child(1) img").click()
