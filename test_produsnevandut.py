...
class TestProdusnevandut():
  ...
  def test_produsnevandut(self):
    # Test name: produsnevandut
    ...
    # 12 | click | linkText=Sales, highest to lowest | 
    self.driver.find_element(By.LINK_TEXT, "Sales, highest to lowest").click()
    # 13 | click | css=.js-product:nth-child(3) img | 
    ...
    # 31 | click | css=.logo | 
    self.driver.find_element(By.CSS_SELECTOR, ".logo").click()
    # 32 | click | linkText=All best sellers | 
    self.driver.find_element(By.LINK_TEXT, "All best sellers").click()
    # 33 | click | css=.select-title | 
    self.driver.find_element(By.CSS_SELECTOR, ".select-title").click()
    # 34 | click | linkText=Sales, highest to lowest | 
    self.driver.find_element(By.LINK_TEXT, "Sales, highest to lowest").click()
    # 35 | click | css=.js-product:nth-child(3) img | 
    self.driver.find_element(By.CSS_SELECTOR, ".js-product:nth-child(3) img").click()
