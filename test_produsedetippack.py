...
class TestProdusedetippack():
  ...
  def test_produsedetippack(self):
    # Test name: produsedetippack
    ...
    # 9 | click | css=.js-product:nth-child(7) img | 
